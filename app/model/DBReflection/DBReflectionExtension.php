...
use FKSDB\DBReflection\ColumnFactories\{
    DateRow,
    DateTimeRow,
    EmailColumnFactory,
    EmailListColumnFactory,
    IntColumnFactory,
    LogicColumnFactory,
...
class DBReflectionExtension extends CompilerExtension {
        ...
        if (is_array($field)) {
            switch ($field['type']) {
                ...
                case 'email':
                    ...
                    break;
                case 'emailList':
                    $this->registerEmailListRow($factory, $tableName, $fieldName, $field);
                    break;
                case 'state':
     ...
     * @return void
     */
    private function registerEmailListRow(ServiceDefinition $factory, string $tableName, string $fieldName, array $field) {
        $this->setUpDefaultFactory($factory, $tableName, $fieldName, EmailListColumnFactory::class, $field);
