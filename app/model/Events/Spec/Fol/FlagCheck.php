...
//                };
     ...
     */
    private function getStudyYear(IControl $studyYearControl, IControl $personControl) {
     ...
     * @return bool|mixed|ActiveRow|Selection|null
     */
    private function getSchoolId(IControl $schoolControl, IControl $personControl) {
