import ChartComponent from '@FKSDB/Components/Controls/Chart/ChartComponent';
import {
    getAreaPath,
    getLinePath,
    LineChartData,
} from '@FKSDB/Components/Controls/Chart/LineChart/Middleware';
...
export default class LineChartComponent extends ChartComponent<OwnProps, {}> {
