import {app, Store} from 'FKSDB/Components/Schedule/Input/reducer';
...
function Group({group}: GroupOwnProps) {
...
function GroupInfo({group}: GroupOwnProps) {
    const translator = useContext(TranslatorContext);
            ...
            <div
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">
                        {params.price && <small className="me-3">
                            {translator.getText('Price')}: <PricePrinter price={price} translator={translator}/>
                        </small>}
                        {params.capacity && totalCapacity && <small
                            className={'me-3 ' + ((totalCapacity <= usedCapacity) ? 'text-danger' : '')}>
                            {translator.getText('Free capacity')}:&nbsp;{(totalCapacity - usedCapacity)}
                        </small>}
                    </p>
                </div>
            </div>
