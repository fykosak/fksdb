...
namespace FKSDB\Model\Events\Spec\Dsef;
...
class GroupOptions implements IOptionsProvider {
     ...
     */
    public function __construct(ServiceMDsefParticipant $serviceMParticipant, ServiceDsefGroup $serviceDsefGroup, $includeStates = Machine::STATE_ANY, $excludeStates = ['cancelled']) {
