...
namespace FKSDB\Model\Events\Machine;

use FKSDB\Model\Events\Exceptions\TransitionOnExecutedException;
use FKSDB\Model\Events\Exceptions\TransitionUnsatisfiedTargetException;
