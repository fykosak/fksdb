...
class SettingsPresenter extends BasePresenter
{
    ...
    final public function renderDefault(): void
    {
        if ($this->tokenAuthenticator->isAuthenticatedByToken(ModelAuthToken::TYPE_INITIAL_LOGIN)) {
            $this->flashMessage(_('Set up new password.'), MessageLevel::WARNING->value);
        }
    ...
    private function handleSettingsFormSuccess(Form $form): void
    {
        ...
        $this->flashMessage(_('User information has been saved.'), MessageLevel::SUCCESS->value);
        if ($tokenAuthentication) {
            $this->flashMessage(_('Password changed.'), MessageLevel::SUCCESS->value);
