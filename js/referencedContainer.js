...
// default options
        ...
        transformContainer: function(elContainer, elRefId) {
            ...
            function searchifyContainer() {
                ...
                var searchButton = $('<span class="input-group-btn"><button class="btn btn-primary" type="button"><span class="fa fa-search"></span></button></span>');
...
<div class="' + options.colRight + ' value"><p class="form-control-static"/></div></div>');
                ...
                var buttonEdit = $('<button type="button" class="btn btn-sm btn-primary" title="Upravit"><span class="fa fa-pencil-square-o"></span></button>');
                buttonEdit.click(decompactifyContainer);

                var buttonDel = $('<button type="button" class="btn btn-sm btn-danger" title="Smazat"><span class="fa fa-times"></span></button>');
