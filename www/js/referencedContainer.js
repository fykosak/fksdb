...
// default options
        ...
        transformContainer: function (elContainer, elRefId) {
            ...
            function searchifyContainer() {
                ...
                searchGroup.children('.control-label');
                searchGroup.children('div');
...
<div class="input-group value"><p class="form-control-static form-control"/></div></div>');
                ...
                var buttonEdit = $('<button type="button" class="btn btn-secondary" title="Upravit"><span class="glyphicon glyphicon-edit fa fa-pencil"></span></button>');
                buttonEdit.click(decompactifyContainer);

                var buttonDel = $('<button type="button" class="btn btn-warning" title="Smazat"><span class="glyphicon glyphicon-remove fa fa-remove"></span></button>');
